...
public class DataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        if (userRepository.count() == 0) {
            ...
            User viewer = new User("viewer1", "viewer@editor.com", "pass", Role.VIEWER);
            ...
            Document doc1 = new Document("Project Plan", "This is the initial project plan for the Spring Boot application.", admin);
